...
(function($){
    $(function(){
        ...
        $('#download-form').submit(function(e){
            var $form = $(this),
                first_name = $form.find('#first-name-input').val(),
                val = $form.find('#email-input').val();
                ...
                $.ajax({
                    ...
                    success:function(data){
                        if(data == 'invalid_email')
                            ...
                            $body.addClass('download-form-submitted');
                            $('#form-submitted-message').addClass('showing');
                        }
                        else if (data == 'error'){
                            $form.addClass('submitted');
                            $body.addClass('download-form-submitted');
                            $('#form-error-message').addClass('showing');
                        }
            ...
            return false
            //console.log($form.find('#email-input').val());
